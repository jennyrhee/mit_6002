# mit_6002/pset3
Designed and implemented a stochastic simulation of patient and virus population dynamics.

## Background: Viruses, Drug Treatments, and Computational Models (from MIT)
